...
activities = {
    ...
    ,
    "Soccer Team": {
        "description": "Competitive soccer team practicing teamwork, strategy, and fitness",
    ...
    "Art Club": {
        "description": "Exploring visual arts, drawing, painting, and group projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["isabella@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Society": {
        "description": "Theatre production, acting workshops, and stagecraft",
        "schedule": "Mondays and Wednesdays, 6:00 PM - 8:00 PM",
        "max_participants": 25,
        "participants": ["ethan@mergington.edu", "lucas@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Team-based scientific problem solving and competition preparation",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "charlotte@mergington.edu"]
    },
    "Debate Team": {
        "description": "Competitive debating, public speaking, and critical thinking practice",
